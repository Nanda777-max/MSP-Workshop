<template>
    <div class="appcontainer">
        ...
        <h4 style="font-size:22px">todo</h4>
    ...
    <button @click="deletetodo(item.id)" class="deletebtn"><i class="material-icons" style="color:red">close</i></button>
...
<div class="col-2"  style="padding-top: 5px">
            ...
            <button @click="markascomplete(item.id)" class="donebtn"><i class="material-icons" style="color:green">done</i></button>
        ...
        <div style="border-bottom: 1px solid lightgrey; margin-top:10px">
            ...
            <div class="row">
                <div class="col-10">
                 ...
                 <div class="col-2">
                     <button @click="addtodo" class="addbtn"><i class="material-icons" style="color:blue">add</i></button>
                </div>
            </div>
        ...
        <div style="margin-top:20px">
            ...
            <router-link to="/completed"> completed({{this.$store.state.completed}})<i class="material-icons" style="position:relative">arrow_forward</i></router-link>
